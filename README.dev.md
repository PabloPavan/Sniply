# Sniply API — Onboarding Guide (Docker & Deploy)
This document explains **how to run, develop, migrate, and deploy** Sniply API using Docker Compose.
...
Sniply API runs as **a single Docker stack**, composed of:
