...
**Sniply API** is a modern, production‑ready backend service for storing, searching, and managing **text and code snippets**.
...
That document describes the recommended and correct way to run Sniply API with Docker in development environments.
